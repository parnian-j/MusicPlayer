...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<String> _updateProfileOnServer({
    ...
    final socket = await Socket.connect("192.168.100.7", 12344,
        timeout: const Duration(seconds: 5)); // IP سرورت رو بزار اینجا
    ...
    socket.writeln(jsonEncode(request)); // مهم: \n می‌فرسته
    await socket.flush();
                ...
                onPressed: () async {
                  try {
                    ...
                    final request = {
                      ...
                      "payloadJson": widget.username, // فقط رشته‌ی خام
                    };
